...
$cari = $_POST['cari'];
$process = mysqli_query($conn, "SELECT * FROM penjualan where PenjualanID like '%$cari%' or TanggalPenjualan like '%$cari%' or TotalHarga like '%$cari%' or PelangganID like '%$cari%'");
...
<body>
    ...
    <a href="formPenjualan.php"><button>Tambah Produk</button></a>
